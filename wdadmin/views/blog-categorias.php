<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor">Categorias do Blog</h3>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div id="div_tabela" class="table-responsive">
                        <table id="tabela_blog_categorias" class="table table-sm table-hover table-striped table-bordered" cellspacing="0" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Posição</th>
                                    <th>Descrição</th>
...
<script src="<?php echo URL ?>wdadmin/scripts/blog-categorias.js"></script>