<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor">Cadastro de Marcadores do Blog</h3>
    </div>
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo URL ?>wdadmin/inicio">Home</a></li>
            <li class="breadcrumb-item"><a href="<?php echo URL ?>wdadmin/blog-marcadores">Marcadores do Blog</a></li>
            ...
            <div class="card text-center">
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs" role="tablist">
                        ...
                        <li class="botao_novo">
                            <a class="btn btn-info btn-sm" href="<?php echo URL ?>wdadmin/blog-marcadores/cadastro">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane p-20 active" id="cadastro" role="tabpanel">
                            <form id="form_blog_marcadores" method="post" enctype="multipart/form-data">
                                <input type="hidden" id="inputIdMarcadoresBlog" name="inputIdMarcadoresBlog" value="<?php echo $id ?>" />
...
<script src="<?php echo URL ?>wdadmin/scripts/blog-marcadores-cadastro.js"></script>