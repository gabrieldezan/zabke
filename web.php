...
<html lang="pt-br">
    <head>
        ...
        include 'php/css.php';
        ?>
        <title>Zabke Tecnologia - Web</title>
    </head>
                            ...
                            <div class="col-lg-6">
                                <div class="why-right">
                                    <div class="ot-heading">
                                        <span>// Web</span>
                                        <h2 class="main-heading">Layouts modernos<br/> e personalizáveis</h2>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-6 text-center">
                                            <div class="ot-counter text-white">
                                                ...
                                                <h6 class="text-white">Anos de Experiência</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <section class="service-web-video">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="offset-xl-1 col-xl-6 col-lg-6 split-right-img bg-video">
                                <div class="video-popup">
                                    <div class="btn-inner">
                                        <a class="btn-play" href="https://www.youtube.com/watch?v=Heh3TapGBCY">
