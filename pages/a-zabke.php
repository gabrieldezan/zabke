...
<html lang="pt-br">
    <head>
        ...
        <meta property="og:title" content="<?php echo $voResultadoConfiguracoes->titulo . " - A Zabke" ?>"/>
        <meta property="og:description" content="<?php echo $voResultadoConfiguracoes->descricao ?>"/>
        <meta property="og:image" content="<?php echo "https://" . $_SERVER['HTTP_HOST'] . URL . "a-zabke" ?>"/>
        <meta property="og:url" content="<?php echo "https://" . $_SERVER['HTTP_HOST'] . URL . "a-zabke" ?>"/>
