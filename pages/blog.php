    ...
    if ($viNumRowsTotal == 0 || $numero_pagina > $num_paginas) {
        ...
        <html lang="pt-br">
            <head>
                ...
                <meta property="og:title" content="<?php echo $voResultadoConfiguracoes->titulo . " - Blog" ?>"/>
                <meta property="og:description" content="<?php echo $voResultadoConfiguracoes->descricao ?>"/>
                <meta property="og:image" content="<?php echo "https://" . $_SERVER['HTTP_HOST'] . URL . "blog" ?>"/>
                ...
                <title><?php echo $voResultadoConfiguracoes->titulo . " - Blog" ?></title>
            </head>
                                ...
                                <div class="row">
                                                    ...
                                                    <div class="inner-post">
                                                        <div class="entry-header">
                                                            <div class="entry-meta">
                                                                <span class="posted-on"><a><i class="fas fa-clock"></i> <?php echo $voResultadoBlog->data_publicacao ?></a></span>
                                                            </div>
                                                            <h3 class="entry-title"><a href="<?php echo URL . "post/" . $voResultadoBlog->url_amigavel ?>"><?php echo $voResultadoBlog->titulo ?></a></h3>
                                                        </div>
                                                        <div class="btn-readmore">
                                                            <a href="<?php echo URL . "post/" . $voResultadoBlog->url_amigavel ?>"><i class="flaticon-right-arrow-1"></i>VER MAIS</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </article>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <ul class="page-pagination none-style">
                                            <li><a class="prev page-numbers" href="<?php echo URL . "blog" ?>"><i class="flaticon-back"></i></a></li>
                                            <?php
                                            $limite = 10;
                                            ...
                                            for ($i = $minimo; $i < $maximo; $i++) {
                                                ...
                                                if ($numero_pagina == $i + 1)
                                                    $estilo = "current";
                                                ?>
                                                <li><a class="page-numbers <?php echo $estilo ?>" href="<?php echo URL . "blog/" ?><?php echo $i + 1 ?>"><?php echo $i + 1 ?></a></li>
                                            <?php } ?>
                                            <li><a class="next page-numbers" href="<?php echo URL . "blog/" . $num_paginas ?>"><i class="flaticon-right-arrow-1"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
