...
<html lang="pt-br">
    ...
    <head>
        ...
        include 'php/css.php';
        ?>
        <title>Zabke Tecnologia - App</title>
    </head>
            ...
            <div id="content" class="site-content">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <div class="ot-heading">
                                    <span>// app</span>
                                    <h2 class="main-heading">Desenvolvimento de apps personalizado</h2>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xl-3 col-lg-6 no-padding">
                                <img src="images/metricas-app1.jpg" alt="" class="img-full">
                            </div>
                            <div class="col-xl-3 col-lg-6 no-padding align-self-center">
                                <div class="ot-counter2">
                                    ...
                                    <div class="b-num">330</div>    
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-6 order-lg-last no-padding">
                                <img src="images/metricas-app2.jpg" alt="" class="img-full">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 align-self-center">
                                <div class="right-about-v4">
                                    <div class="ot-heading">
                                        <span>// Zabke Tecnologia</span>
                                        <h2 class="main-heading">Conheça mais sobre a Zabke Tecnologia</h2>
                                    </div>
                                    ...
                                    <div class="video-popup style-2">
                                        <div class="btn-inner">
                                            <a class="btn-play" href="https://www.youtube.com/watch?v=Heh3TapGBCY"><i class="flaticon-play"></i>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                                <div class="ot-pricing-table">
                                    ...
                                    <div class="inner-table">
                                        <h4 class="title-table">Plano Básico</h4>
                                        <h2><sup>R$</sup> 129,99</h2>
                            ...
                            <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                                <div class="ot-pricing-table">
                                    <div class="icon-main"><span class="flaticon-report"></span></div>
                                    <div class="inner-table">
                                        <h4 class="title-table">Plano Econômico</h4>
                                        <h2><sup>R$</sup> 159,99</h2>
                                        <span>Pacote Mensal</span>
                                        <div class="details ">
                                            <ul>
                                                <li class="active">Web Counsulting</li>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="ot-pricing-table">
                                    ...
                                    <div class="inner-table">
                                        <h4 class="title-table">Plano Premium</h4>
                                        <h2><sup>R$</sup> 189,99</h2>
                                        <span>Pacote Mensal</span>
                                        <div class="details ">
                                            <ul>
                                                <li class="active">Web Counsulting</li>
                ...
                <section class="section-consultation">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <p>// Possui alguma dúvida! Estamos aqui para responder todas suas perguntas</p>
                                <h2>FAÇA UMA DEMONSTRAÇÃO</h2>
                                <div class="ot-button">
                                    <a href="contato.php" class="octf-btn octf-btn-primary">Fale Conosco</a>
                                </div>
                            </div>
                        </div>
                    </div>
